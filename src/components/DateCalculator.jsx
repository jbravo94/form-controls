...
export class DateCalculator extends addMoreDecorator(Component) {
...
const DateCalculatorWithIntl = injectIntl(DateCalculator, { forwardRef: true });

export { DateCalculatorWithIntl };
